...
for i in thread_sold:
  lst = []
  if i == 'red' or i == 'white' or i == 'purple' or i == 'black' or i == 'blue' or i == 'green' or i == 'yellow':
...
for i in colors:
  print('Thread Shed sold ' , color_count(i) , ' threads of ' + i + ' threads today.' )